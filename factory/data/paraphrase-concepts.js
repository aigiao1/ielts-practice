// 雅思同义替换零件库 (Paraphrase Semantic Parts & Concept Clusters)
(() => {
  "use strict";
  ...
  const PARAPHRASE_CONCEPTS = [
    // 1. CONDITIONAL_SUSTAINABILITY (Level 3)
    {
    ...
    // 4. COMMUNAL_INTERACTION (Level 2)
    {
    ...
    // 5. CREATIVITY_STIMULATION (Level 2)
    {
    ...
    // 14. RESTRICTED_CAPACITY (Level 2)
    {
    ...
    // 15. DISPROPORTIONATE_BENEFIT (Level 4)
    {
    ...
    // 18. WEATHER_POSTPONEMENT (Level 2)
    {
    ...
    // 19. AUTONOMOUS_LEARNING (Level 3)
    {
    ...
    // 22. HERITAGE_PRESERVATION (Level 3)
    {
  ...
  if (typeof window !== "undefined") {
    window.DISTRACTOR_GROUPS = DISTRACTOR_GROUPS;
    window.PARAPHRASE_CONCEPTS = PARAPHRASE_CONCEPTS;
  }
  if (typeof module !== "undefined" && module.exports) {
    module.exports = { DISTRACTOR_GROUPS, PARAPHRASE_CONCEPTS };
  }
})();
